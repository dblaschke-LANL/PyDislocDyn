...
\noindent
This manual is intended as a brief introduction on how to use the most common features of PyDislocDyn 1.2.7 and higher \cite{pydislocdyn}.
...
As of PyDislocDyn >1.2.7, required modules include Numpy $\ge1.17$, Scipy $\ge1.3$, Sympy $\ge1.6$, Matplotlib $\ge3.1$, and Pandas $\ge1.1$ (though Pandas $\ge1.3$ including its optional dependency Jinja2 is recommended).
