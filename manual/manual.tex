...
\noindent
This manual is intended as a brief introduction on how to use the most common features of PyDislocDyn 1.3.1 and higher \cite{pydislocdyn,Blaschke:2025joss}.
...
a Fortran compiler supported by numpy.f2py to compile the optional Fortran subroutines, Joblib $\ge1.1$ (for parallelization),
...
See the readme file for additional information on installing PyDislocDyn and compiling its subroutine module.
