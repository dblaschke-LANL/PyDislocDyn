...
Required modules include Numpy, Scipy, Sympy, Matplotlib, and Pandas with their minimum Python 3.8-compatible versions, except for Sympy where we require 1.6 or higher.
